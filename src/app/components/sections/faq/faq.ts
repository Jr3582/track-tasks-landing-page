...
export class FaqComponent {
  faqCards = [
    ...
    {title: "Who Is Just Checks For?", description: "Just Tasks is perfect for students, professionals, sales teams, recruiters, consultants, executives, and anyone who needs to perform well in meetings. If you're in back-to-back sales calls, lectures, or client meetings where you can't afford to look unprepared, Just Tasks delivers you answers at moments when you most need them."},
