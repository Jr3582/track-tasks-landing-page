...
export class FeaturesComponent {
  features = [
    ...
    {featureName: "Keep Organized", featureDescription: "Move tasks through a clear four-stage pipeline To Do, In Progress, In Review, Done, so you always know exactly where things stand. No more guessing what's next."}
  ]
